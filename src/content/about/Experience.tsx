...
export function Experience() {
    const experiences = [
        ...
        { company: "Freelance", role: "Architect & Designer", years: "2016 ~", row: 3, colStart: 10, colSpan: 16 },
            ...
            <div className="w-full px-4">
                <div className="timeline-grid sm:grid grid-cols-26 grid-rows-5 gap-2 space-y-4">
                    {experiences.map((exp, index) => (
                        <div
                            key={index}
                            className="flex items-center justify-between rounded-2xl bg-primary p-3 text-white shadow-2xl hover:shadow-xl"
                            style={{
